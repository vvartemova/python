...
start = input('Введите слово => ')
word = list(start.upper())
sum = 0
for element in word:
    if element in dict_russian:
        sum = sum + dict_russian[element]
    if element in dict_english:
        sum = sum + dict_english[element]
